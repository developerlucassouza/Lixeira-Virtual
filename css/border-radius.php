...
<div class="lesson">
    ...
    <p>A propriedade <code>border-radius</code> irá criar um arredondamento nos cantos de uma tag HTML.</p>

    <div class="code">
        <pre>border-radius: 20px;</pre>
    </div>
    <div class="teste" style="border-radius: 20px;">
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Obcaecati reprehenderit consequatur accusamus
            voluptatum, molestiae placeat dolores vitae. Perferendis hic temporibus, vero non quis eligendi facilis
            provident, suscipit, eius ea illum.</p>
    </div>
...
.quadrado {
    ...
    <div class="quadrado" style="border-radius: 50%;"></div>F
</div>
