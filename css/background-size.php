...
<div class="lesson">
    <h1>background-size CSS</h1>
        <p>O <code>background-size</code> é utilizado para controlar o tamanho da imagem de fundo definida com <code>background-image</code>, </p>
        ...
        <p>Para exemplificar, a seguinte imagem será utilizada como <code>background-image</code></p>
