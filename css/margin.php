...
<div class="lesson">
    <h1>margin CSS</h1>
    <p>A propriedade <ccode>margin</ccode> é utilizada para definir o espaço em torno de um elemento
        <code>HTML</code>. Ela controla o espaço entre as bordas do elemento e outros
        elementos adjacentes.</p>
    <p>Normalmente, utiliza-se a medida em <code>px</code>, mas pode-se utilizar outros valores de medida como
        <code>%</code>.</p>
...
margin: 10px 20px 10px 30px;</pre>
    ...
    <p>Podemos utilzar o <code>margin: auto;</code> juntamente do <code>display: block;</code>
        para centralizar uma div horizontalmente.</p>
