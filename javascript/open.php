...
<div class="lesson">
    ...
    <p><em><code>target</code> é um atributo de links (<code>&lta></code>) que define se o link será aberto na mesma
            guia ou em uma nova guia, sendo <code>_self</code> na mesma guia e <code>_blank</code> em uma nova
            guia.</em></p>
    <p>Exemplo:</p>
    <div class="code">
        <pre>
