...
<div class="lesson">
    <h1>Funções JS</h1>
    <p>Em programação, uma função é um bloco de código que realiza uma tarefa específica e pode ser chamado a partir de
        outro lugar do programa. As funções são uma maneira de organizar e reutilizar código, facilitando a
        modularização e a manutenção do código.</p>
