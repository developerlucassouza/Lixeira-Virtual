...
<div class="lesson">
    ...
    <p>Em JavaScript, o tratamento de erros é realizado usando as declarações <code>try</code> e <code>catch</code>.
        Essas declarações ajudam a lidar com exceções (erros) que podem ocorrer durante a execução do código.</p>
    ...
    <p>Dentro dos parenteses do <code>catch</code>, será possível criar uma variável de erro, e depois mostrar o erro
        com o <code>.message</code>.</p>
