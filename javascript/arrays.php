...
<div class="lesson">
    <h1>Arrays JS</h1>
    <p>Em programação, um array (também chamado de variável composta) é uma estrutura de dados que armazena uma coleção
        ordenada de elementos, onde cada elemento pode ser acessado por um índice ou uma chave. Os elementos em um array
        podem ser de qualquer tipo de dado, como números, strings, objetos, ou até mesmo outros arrays, dependendo da
...
<span class="comentario">// [5, 18, 2, 1, 7]</span>   </pre>
    ...
    <hr>
    <p>A propriedade <code>.length</code> irá retornar o tamanho do Array, isto é, a quantidade de valores dentro do
        Array.</p>
    <div class="code">
        <pre>
nums.length;
...
<span class="comentario">// [1, 2, 5, 7, 18]</span></pre>
    </div>
