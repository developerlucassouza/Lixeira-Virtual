...
<div class="lesson">
    ...
    <p>Selecionar elementos no <a href="oqueedom.php">DOM</a> é uma parte essencial da manipulação dinâmica de páginas
        web usando JavaScript.</p>
    ...
    <h2>Por ID</h2>
    <p>A maneira mais utilizada para selecionar um elemento em específico é atravéz de <a href="../css/id.php">ID</a>.
    </p>
    <div class="code">
    ...
    <h2>Por Seletor</h2>
    <p>Este irá englobar a maioria das anteriores, selecinando pelo seletor utilizado também em
