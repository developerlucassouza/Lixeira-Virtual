...
<div class="lesson">
    ...
    <p>Eventos DOM são interações do usuário ou alterações no estado da página que o navegador pode detectar e lidar,
        isto é, tudo aquilo que pode acontecer com um elemento.</p>
    <p>Exemplo: clicar, colocar o mouse em cima, apertar uma teclas, etc.</p>
    <p>Com isso, podemos executar ações para determinados eventos que podem acontecer, vamos exemplificar com um evento
        de click:</p>
    <div class="scrollx">
        <table class="ml-20">
            <tr>
    ...
    <hr>
    <p>Mesmo o evento se chamando <code>click</code>, ao usa-lo diretamente no <code>HTML</code>, devemos utilizar o
        <code>on</code> antes, ficando assim <code>onclick</code>.</p>
    <p>Todos os eventos escritos dentro da tag HTML necessita do <code>on</code>, veja um exemplo com o evento
        <code>mouseenter</code>:</p>
    <div class="scrollx">
        <table class="ml-20">
            <tr>
                <th>Evento</th>
    ...
    <hr>
    <p>Também podemos atribuir os eventos pelo JavaScript utilizando a função <code>.addEventListener()</code> e uma <a
            href="funcoes.php">função</a> com as ações que desejamos.</p>
    <div class="code">
...
&lt/script></pre>
    ...
    <p>Para ver todos os eventos, acesse <a target="_blank"
            href="https://developer.mozilla.org/en-US/docs/Web/Events">MDN Web Docs - Event Reference</a>.</p>
