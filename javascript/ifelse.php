...
<div class="lesson">
    <h1>if/else JS</h1>
    <p>A estrutura condicional <code>if</code> e <code>else</code> são usadas em <code>JavaScript</code> (e em muitas
        outras linguagens de programação) para controlar o fluxo de execução do código com base em condições booleanas.
    </p>
    <p>Se a condição dentro do <code>if</code> for verdadeira, o bloco de código dentro do <code>if</code> é executado.
        Se a condição for falsa, o bloco de código dentro do <code>else</code> (se existir) é executado.</p>
    <div class="code">
        <pre>
...
if (x > 10) {
    ...
    <hr>
    <p>No exemplo abaixo, será perguntado um número para o usuário por meio de <code>prompt()</code>, e será mostrado o
        resultado com <code>alert()</code>.</p>
    <div class="code">
        <pre>
