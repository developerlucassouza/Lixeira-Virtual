...
<div class="lesson">
    ...
    <p>Manipulação de strings refere-se à aplicação de operações ou transformações em cadeias de caracteres (strings).
        Uma string é uma sequência de caracteres, como texto ou palavras. A manipulação de strings é uma parte
        fundamental da programação, pois muitas vezes você precisa trabalhar com dados de texto e realizar diversas
        operações neles.</p>
    <p>A manipulação de strings em JavaScript pode ser feita usando uma variedade de métodos. Aqui estão alguns dos
        métodos mais comuns:</p>
...
<span class="comentario">// Resultado: 10</span></pre>
    ...
    <p>Podemos acessar caracteres separadamente, utilizando os colchetes <code>[]</code> no final da variável com a
        <code>string</code>, dentro tendo a posição que deseja ver.</p>
...
<span class="comentario">// Resultado: "H"</span></pre>
    ...
    <h2>Método slice()</h2>
    <p>O método <code>slice()</code> irá resultar uma <code>substring</code> baseado em uma <code>string</code> já
        existente, indicando a posição de inicio e a posição final.</p>
...
<span class="comentario">// Resultado: "Java"</span></pre>
    ...
    <p>Com o método <code>.indexOf()</code> você pode pesquisar uma <code>substring</code>, retornando a posição em que
        ela começa.</p>
...
<span class="comentario">// Resultado: "Hello JavaScript"</span></pre>
    ...
    <p>Os métodos <code>.toUpperCase()</code> e <code>.toLowerCase()</code> irão, respectivamente, transformar todas as
        letras em maiúsculas e minúsculas.</p>
    <div class="code">
        <pre>
let str = "JavaScript";
...
<span class="comentario">// Resultado: "javascript"</span></pre>
    ...
    <p>Com o método <code>.trim()</code>, será removido todos os espaços em branco do início e do fim da
        <code>string</code>.</p>
    <div class="code">
        <pre>
let str = "   Trim me!   ";
