...
<div class="lesson">
    <h1>JS write()</h1>
    <p>O comando <code>write()</code> tem como função escrever algo no documento
        <code><a href="../html/">HTML</a></code> atravéz de <code><a href="./">JavaScript</a></code>. Veja o seguinte
        exemplo:</p>
    <div class="code">
        <pre>
...
&lt/script&gt</pre>
    ...
    <p>Perceba que vários comandos que modificam o <code><a href="../html/">HTML</a></code> irão iniciar com
        <code>document.</code>, pois se trata de um comando pertencente ao documento.</p>
    <hr>
...
&lt/script&gt</pre>
    ...
    <hr>
    <p>Com isso, podemos usar um <code><a href="ifelse.php">if</a></code> para decidir o que será mostrado e o que não
        será mostrado:</p>
    <div class="code">
        <pre>
&ltscript>
